...
def run():
    ...
    link = '[©Developed by Akash Kumar Jha](https://https://www.linkedin.com/in/akashkumar107/)'
...
st.write('''
    Dashboard created by [Akash Kumar Jha](https://linkedin.com/in/akashkumar107/), with [Streamlit](https://www.streamlit.io).
